"""Script for processing (APP group). Handle data imputation (forward filling) (WORK ON 2021.1.3 IDE VERSION).
...
# Consider only APP patients
data = data[data['X03_Group'] == 1]
...
data["Total_Time_PP"] = data.loc[:, "X50_TimePP0": "X53_TimePP3"].sum(axis=1)
data["Avg_Daily_Time_PP"] = data.loc[:, "X50_TimePP0": "X53_TimePP3"].mean(axis=1, skipna=True)  # NaN not included

# Adjust Daily Avg with D0 duration
# Check if you have time in minutes or in hours
if data["X51_TimePP1"].max() > 24:  # Here, they are in minutes
    data["Avg_Daily_Time_PP_Adjusted"] = (data["X50_TimePP0"] / data['X49_Duration_D0'] * 1440 +
                                          data["X51_TimePP1"] + data["X52_TimePP2"] + data["X53_TimePP3"]) / 4
else:
    data["Avg_Daily_Time_PP_Adjusted"] = (data["X50_TimePP0"] / data['X49_Duration_D0'] * 24 +
                                          data["X51_TimePP1"] + data["X52_TimePP2"] + data["X53_TimePP3"]) / 4

data['X33a_SF_PrePP'] = data['X33_SpO2_PrePP'] / data['X39_FiO2_PrePP']
data['X33b_SF_IntraPP'] = data['X34_SpO2_IntraPP'] / data['X40_FiO2_IntraPP']
data['X33c_SF_PostPP'] = data['X35_SpO2_PostPP'] / data['X41_FiO2_PostPP']
data['X48a_ROX_PrePP'] = data['X33a_SF_PrePP'] / data['X42_RR_PrePP']
data['X48b_ROX_IntraPP'] = data['X33b_SF_IntraPP'] / data['X43_RR_IntraPP']
data['X48c_ROX_PostPP'] = data['X33c_SF_PostPP'] / data['X44_RR_PostPP']

data['X45a_Delta_Post_PP_SpO2'] = data['X35_SpO2_PostPP'] - data['X33_SpO2_PrePP']
data['X45b_Delta_Post_PP_FiO2'] = data['X41_FiO2_PostPP'] - data['X39_FiO2_PrePP']

data['X33d_Delta_Per_PP_SF'] = data['X33b_SF_IntraPP'] - data['X33a_SF_PrePP']
data['X33e_Delta_Post_PP_SF'] = data['X33c_SF_PostPP'] - data['X33a_SF_PrePP']
data['X44a_Delta_Per_PP_RR'] = data['X43_RR_IntraPP'] - data['X42_RR_PrePP']
data['X44b_Delta_Post_PP_RR'] = data['X44_RR_PostPP'] - data['X42_RR_PrePP']
data['X48d_Delta_Per_PP_ROX'] = data['X48b_ROX_IntraPP'] - data['X48a_ROX_PrePP']
data['X48e_Delta_Post_PP_ROX'] = data['X48c_ROX_PostPP'] - data['X48a_ROX_PrePP']
...
longi_data = data.loc[:, [
                             ...
                             'X50_TimePP0', 'X51_TimePP1', 'X52_TimePP2', 'X53_TimePP3',
...
longi_D0 = longi_data[['X50_TimePP0',
                       'X12_SpO2_enrol',
                       'X14_FiO2_enrol',
                       'X18_RR_enrol',
                       'X200_SF_enrol',
...
longi_D1 = longi_data[['X51_TimePP1',
                       'X65_SpO2_D1',
                       'X68_FiO2_D1',
                       'X74_RR_D1',
                       'SF_D1',
...
longi_D2 = longi_data[['X52_TimePP2',
                       'X66_SpO2_D2',
                       'X69_FiO2_D2',
                       'X75_RR_D2',
                       'SF_D2',
...
longi_D3 = longi_data[['X53_TimePP3',
                       'X67_SpO2_D3',
                       'X70_FiO2_D3',
                       'X76_RR_D3',
                       'SF_D3',
...
longi_D0 = longi_D0.rename(columns={'X50_TimePP0': 'TimePP',
                                    'X12_SpO2_enrol': 'SpO2',
                                    'X14_FiO2_enrol': 'FiO2',
                                    'X18_RR_enrol': 'RR',
                                    'X200_SF_enrol': 'SF',
...
longi_D1 = longi_D1.rename(columns={'X51_TimePP1': 'TimePP',
                                    'X65_SpO2_D1': 'SpO2',
                                    'X68_FiO2_D1': 'FiO2',
                                    'X74_RR_D1': 'RR',
                                    'SF_D1': 'SF',
...
longi_D2 = longi_D2.rename(columns={'X52_TimePP2': 'TimePP',
                                    'X66_SpO2_D2': 'SpO2',
                                    'X69_FiO2_D2': 'FiO2',
                                    'X75_RR_D2': 'RR',
                                    'SF_D2': 'SF',
...
longi_D3 = longi_D3.rename(columns={'X53_TimePP3': 'TimePP',
                                    'X67_SpO2_D3': 'SpO2',
                                    'X70_FiO2_D3': 'FiO2',
                                    'X76_RR_D3': 'RR',
                                    'SF_D3': 'SF',
...
# Save unimputed and unscaled inputs and targets to specifically process them in prediction.py
inputs.to_pickle(os.path.join(PROCESSED_PATH, 'inputs_nan.pkl'))
targets[targets_list].to_pickle(os.path.join(PROCESSED_PATH, 'targets_nan.pkl'))
...
inputs.to_pickle(os.path.join(PROCESSED_PATH, 'inputs.pkl'))
targets.to_pickle(os.path.join(PROCESSED_PATH, 'targets.pkl'))
